...
<html lang="en">
  <head>
    <script type="module" crossorigin src="/assets/polyfills.CCC9jABsCnBVP_R0u1prYC.js"></script>
    ...
    <script type="module" crossorigin src="/assets/index.DZ2frkZ0gAHhmmsH3Ym_kO.js"></script>
    <link rel="stylesheet" crossorigin href="/assets/index.e-Rfvek874WYh5g8aiJcS.css">
  ...
  <body class="text-sm text-ds-default-text bg-ds-background">
    ...
    <script nomodule crossorigin id="vite-legacy-polyfill" src="/assets/polyfills-legacy.CY5asy7kfjnZx1j-KYucM4.js"></script>
    <script nomodule crossorigin id="vite-legacy-entry" data-src="/assets/index-legacy.DddNsTm4QHpwG6fmq74FWq.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
